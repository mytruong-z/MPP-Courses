package lab5.src.prob1.gui;

import lab5.src.prob1.rulesets.CDRuleSet;
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt){
			...
			try {
				...
				JOptionPane.showMessageDialog(CDWindow.this, "All data are valid!");
			} catch(Exception ex) {
				JOptionPane.showMessageDialog(CDWindow.this, "Error: "+ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
			}
		}
	}
