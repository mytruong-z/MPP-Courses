package lesson9.startupCodeLab9Part1.prob3;
...
public class Employee {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(list.stream().sorted(Comparator.comparing((Employee emp) -> emp.getName()).thenComparing((Employee emp) -> emp.getSalary())).collect(Collectors.toList()));
    }
}
